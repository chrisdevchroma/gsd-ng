...
**New Template:**
- Implementation: `gsd-ng/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `gsd-ng/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/gsd-ng/workflows/{name}.md`

**New Reference Document:**
- Implementation: `gsd-ng/references/{name}.md`
