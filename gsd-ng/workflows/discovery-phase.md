...
See ~/.claude/gsd-ng/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/gsd-ng/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/gsd-ng/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/gsd-ng/templates/discovery.md
...
Use ~/.claude/gsd-ng/templates/discovery.md.
