...
```bash
node "$HOME/.claude/gsd-ng/bin/gsd-tools.cjs" todo complete "$ORIGIN_TODO_FILE"
node "$HOME/.claude/gsd-ng/bin/gsd-tools.cjs" commit "docs: close todo after quick task" --files .planning/todos/completed/$ORIGIN_TODO_FILE .planning/todos/pending/$ORIGIN_TODO_FILE
```
