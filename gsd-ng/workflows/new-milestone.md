...
```bash
node "$HOME/.claude/gsd-ng/bin/gsd-tools.cjs" config-set git.target_branch "{branch}"
```
...
```bash
node "$HOME/.claude/gsd-ng/bin/gsd-tools.cjs" commit "docs: start milestone v[X.Y] [Name]" --files .planning/PROJECT.md .planning/STATE.md
```

If `--target-branch` was provided, include `.planning/config.json` in the commit:
```bash
node "$HOME/.claude/gsd-ng/bin/gsd-tools.cjs" commit "docs: start milestone v[X.Y] [Name]" --files .planning/PROJECT.md .planning/STATE.md .planning/config.json
```
...
Use template: ~/.claude/gsd-ng/templates/research-project/{FILE}
</output>
...
**Commit requirements:**
```bash
node "$HOME/.claude/gsd-ng/bin/gsd-tools.cjs" commit "docs: define milestone v[X.Y] requirements" --files .planning/REQUIREMENTS.md
```
...
```bash
node "$HOME/.claude/gsd-ng/bin/gsd-tools.cjs" commit "docs: create milestone v[X.Y] roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md
```
