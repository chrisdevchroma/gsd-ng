...
```bash
mkdir -p .planning
node "$HOME/.claude/gsd-ng/bin/gsd-tools.cjs" commit "docs: initialize project" --files .planning/PROJECT.md
```
...
Use template: ~/.claude/gsd-ng/templates/research-project/STACK.md
</output>
...
Use template: ~/.claude/gsd-ng/templates/research-project/FEATURES.md
</output>
...
Use template: ~/.claude/gsd-ng/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: ~/.claude/gsd-ng/templates/research-project/PITFALLS.md
</output>
...
```bash
node "$HOME/.claude/gsd-ng/bin/gsd-tools.cjs" commit "docs: define v1 requirements" --files .planning/REQUIREMENTS.md
```
