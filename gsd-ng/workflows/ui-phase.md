...
Template: ~/.claude/gsd-ng/templates/UI-SPEC.md
</output>
...
```bash
node "$HOME/.claude/gsd-ng/bin/gsd-tools.cjs" commit "docs(${padded_phase}): UI design contract" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-SPEC.md"
```
