...
All notable changes to get-shit-done-ng will be documented in this file.
...
### Changed
- Version reset to 1.0.0 — start of independent get-shit-done-ng versioning lifecycle (forked from upstream v1.22.4)
